 ...
 *
 * @author Low Heng Sin
 * Copied from WPAttributeEditor
 */
public class WBldMtmPartsEditor extends WEditor implements ContextMenuListener
{
	private static final String[] LISTENER_EVENTS = {Events.ON_CLICK, Events.ON_CHANGE, Events.ON_OK};

	private static final CLogger log = CLogger.getCLogger(WBldMtmPartsEditor.class);

	private int m_WindowNo;

	private Lookup bldLookup;
	...
	@Override
	public WBldPartEditBox  getComponent()
	{
		return (WBldPartEditBox) component;
	}
	...
	public void setValue(Object value)
	{
		...
		m_value = value;
		getComponent().setText(bldLookup.getDisplay(value));	//	loads value
	}
	...
	public void onEvent(Event event) throws Exception
	{
		if (Events.ON_CHANGE.equals(event.getName()) || Events.ON_OK.equals(event.getName()))
		{
			...
			if (m_value != null)
			{
				oldText = bldLookup.getDisplay(m_value);
			}
	...
	private void cmd_dialog() throws Exception
	{
		...
		{
			final WBldPartsDialog vad = new WBldPartsDialog (
	...
	{
	   	AEnv.actionZoom(bldLookup, getValue());
	}
