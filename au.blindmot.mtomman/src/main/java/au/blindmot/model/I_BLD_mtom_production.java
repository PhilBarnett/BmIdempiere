...
/** Generated Interface for BLD_mtom_production
 *  @author iDempiere (generated) 
 *  @version Release 4.1
 */
@SuppressWarnings("all")
public interface I_BLD_mtom_production 
{

    /** TableName=BLD_mtom_production */
    public static final String Table_Name = "BLD_mtom_production";
    ...
    /** Column name bld_mtom_production_UU */
    public static final String COLUMNNAME_bld_mtom_production_UU = "bld_mtom_production_UU";

	/** Set bld_mtom_production_UU	  */
	public void setbld_mtom_production_UU (String bld_mtom_production_UU);

	/** Get bld_mtom_production_UU	  */
	public String getbld_mtom_production_UU();
